    ...
    <form id="form1" >
        ...
        <div class="content">
            ...
            <?php
             ...
             $result = mysqli_query($conn, 'select count(MaLoaiSP) as total from loaisanpham');
             ...
             $result = mysqli_query($conn, "sELECT * from loaisanpham order by MaLoaiSP asc LIMIT $start , $limit");
             mysqli_query($conn,"set names 'utf8'");
                 ...
                 <table style="margin: 0 auto;" >
                                 <tr>
                                     <td class="text-center">
                                         <h1><strong>DANH SÁCH LOẠI SẢN PHẨM</strong></h1>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td>
                                 ...
                                 <tr>
                                     <td>
                                         <div class="text-center" >
                                             <table border="2" >
                                             <tr>
                                                 <th width="50" height="35" style="text-align:center; background-color: #006699; color: White">Mã Loại SP</th>
                                                 <th width="400" style="text-align:center; background-color: #006699; color: White">Tên Loại SP</th>
                                             ...
                                             <?php
                                                 ...
                                                 <tr style="color:#000066;">
                                                     ...
                                                     <td>
                                                         <a href="SuaLSP.php<?php echo $link; ?>"><img src='Anh/Icon/Edit.png'></a>
                                                     </td>
                                                     <td>
                                                         <a href="XuLy/XuLyXoaLSP.php<?php echo $link; ?>"> <img src='Anh/Icon/Delete.jpg'></a>
              ...
              <div class="phantrang">
                 ...
                 <?php 
                     ...
                     if ($current_page > 1 && $total_page > 1){
                         echo '<a class="btnDat" href="QuanTriLoaiSanPham.php?page='.($current_page-1).'">Prev</a></button>';
                     }
 	            if($total_page>1)
		    {
                     for ($i = 1; $i <= $total_page; $i++){
                         ...
                         if ($i == $current_page){
                             ...
                             echo '<a class="btnpt" style="color: green;" href="QuanTriLSP.php?page='.$i.'">'.$i.'</a>';
                         }
                     }
                     }
                     if ($current_page < $total_page && $total_page > 1){
                         echo '<a  class="btnDat" href="QuanTriLSP.php?page='.($current_page+1).'">Next</a> ';
                     }
