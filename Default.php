        ...
        <div class="phantrang">
           ...
           <?php 
            ...
            if ($current_page > 1 && $total_page > 1){
                echo '<a class="btnDat" href="Default.php?page='.($current_page-1).'">Prev</a></button>';
            }
            ...
            for ($i = 1; $i <= $total_page; $i++){
                ...
                if ($i == $current_page){
                    ...
                    echo '<a class="btnpt" style="color: green;" href="Default.php?page='.$i.'">'.$i.'</a>';
                }
            }
            
            
            if ($current_page < $total_page && $total_page > 1){
                echo '<a  class="btnDat" href="Default.php?page='.($current_page+1).'">Next</a> ';
            }
