<?php
    ...
    if(empty($_SESSION['LoaiTK'])||$_SESSION['LoaiTK']==1)
    {
  ...
  <div class="container content">
    ...
    <div class="rightmain">
     ...
     <table style="height: 400px;" class="nav-justified">
        <tr>
            <td class="text-center" colspan="2">
                <caption class="text-center"></caption>
                    ...
                    <strong>&nbsp;<br />
                    Sửa Blog</strong></span>
        <tr>
            <td class="text-left" style="height: 37px; width: 124px"><strong>&nbsp;</strong><b>&nbsp;&nbsp; </b><strong>Mã Blog:</strong></td>
            <td style="height: 37px">
                <input id="txtTomTatND" name="txtTomTatND" value="<?php echo $row['MaBlog']?>" type="text" style="height:32px;width:204px;" disabled>
            </td>
        </tr>
        <tr>
            ...
            <td style="height: 46px" class="auto-style46">
                <input id="txtTieuDe" name="txtTieuDe" type="text" value="<?php echo $row['TieuDe']?>"  style="height:32px;width:204px;" >
            </td>
        </tr>
        <tr>
            <td class="text-left" style="height: 37px; width: 124px"><strong>&nbsp;</strong><b>&nbsp;&nbsp; </b><strong>Tóm tắt ND:</strong></td>
            <td style="height: 37px">
                <input id="txtTomTatND" name="txtTomTatND" type="text" value="<?php echo $row['TTND']?>" style="height:32px;width:204px;">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="text-left" style="height: 37px; width: 124px"><strong>&nbsp;</strong><b>&nbsp;&nbsp; </b><strong>Số lượt xem:</strong></td>
            <td style="height: 37px">
